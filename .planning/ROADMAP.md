...
- [ ] **Phase 1: GPU Pod Image & Smoke-Test** — Build and validate the pre-baked inference pod image (llama.cpp + Speaches + Infinity + dcgm-exporter) with VRAM measured under load
...
|-------|----------------|--------|-----------|
| 1. GPU Pod Image & Smoke-Test | 8/9 | In progress | - |
